...
public class Cjms {
	...
	static String Target_Table_Name = "Target_Table_Name";
	static String src_table_1 = "src_tbl_1";
	static String src_table_2 = "src_table_2";
	static String src_table_2_Alias = "src_table_2_Alias";
	static String on_clause = "on_clause";
	static String sourceCntQuery = "sourceCntQuery";
	static String agg_src_full_cnt_query = "agg_src_full_cnt_query";
	static String agg_src_incr_cnt_query = "agg_src_incr_cnt_query";
	static String agg_trgt_full_cnt_query = "agg_trgt_full_cnt_query";
	static String agg_trgt_incr_cnt_query = "agg_trgt_incr_cnt_query";
	static String agg_src1_full_cnt_query = "agg_src1_full_cnt_query";
	static String agg_src1_incr_cnt_query = "agg_src1_incr_cnt_query";
	static String agg_trgt1_full_cnt_query = "agg_trgt1_full_cnt_query";
	static String agg_trgt1_incr_cnt_query = "agg_trgt1_incr_cnt_query";
	...
	public static void main(String[] args) {
		...
		List<Map<Object, Object>> ConfigJoinerMapList = new LinkedList<Map<Object,Object>>();
		...
		ConfigJoinerMapList.add(m1);
		ConfigJoinerMapList.add(m2);
		ConfigJoinerMapList.add(m3);
		ConfigJoinerMapList.add(m4);
		ConfigJoinerMapList.add(m5);
		
		System.out.println("ConfigJoinerMapList :-> " + ConfigJoinerMapList);
