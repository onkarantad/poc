...
//    if (args.length != 1) {
//      System.err.println("D:/DBever_SSMS/General/.dbeaver/credentials-config.json");
//      System.exit(1);
//    }
    System.out.println(decrypt(Files.readAllBytes(Paths.get("D:/postgreSql/TIA/dbConn/General/.dbeaver/credentials-config.json"))));
  }  
