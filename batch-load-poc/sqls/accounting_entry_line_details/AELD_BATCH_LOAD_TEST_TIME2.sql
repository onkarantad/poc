...
--	SI_IDIT_ODS.AC_ENTRY AC_ENTRY
	(select * from SI_IDIT_ODS.AC_ENTRY	WHERE UPDATE_DATE >  '?business_start_date'
        		AND UPDATE_DATE <= '?business_end_date')AC_ENTRY
...
--	WHERE AC_ENTRY.UPDATE_DATE >  '?business_start_date'
--    		AND AC_ENTRY.UPDATE_DATE <= '?business_end_date';